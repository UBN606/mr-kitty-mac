...
FILES = {
    ...
    "controller/Mr-Kitty-Desktop-Speech-Watcher.py": WINDOWS / "shared" / "Mr-Kitty-Desktop-Speech-Watcher.py",
    "controller/Mr-Kitty-Voice.py": WINDOWS / "shared" / "Mr-Kitty-Voice.py",
    "controller/Get-Mr-Kitty-Voice-Model.py": WINDOWS / "shared" / "Get-Mr-Kitty-Voice-Model.py",
    "controller/Mr-Kitty-Controller.ps1": WINDOWS / "shared" / "Mr-Kitty-Controller.ps1",
    "controller/Setup-Mr-Kitty-Voice.cmd": WINDOWS / "shared" / "Setup-Mr-Kitty-Voice.cmd",
    "controller/Setup-Mr-Kitty-Voice.ps1": WINDOWS / "shared" / "Setup-Mr-Kitty-Voice.ps1",
